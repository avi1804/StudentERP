...
class SubstituteFacultyAssignment(Base):
    ...
    subject_assignment_id: Mapped[Optional[int]] = mapped_column(ForeignKey("subject_assignments.id", ondelete="CASCADE"), nullable=True)
    lecture_instance_id: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    ...
    subject_assignment: Mapped[Optional["SubjectAssignment"]] = relationship("SubjectAssignment")
