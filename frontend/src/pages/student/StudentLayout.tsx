...
export function StudentLayout() {
  ...
  const [notificationsList, setNotificationsList] = useState<any[]>([
    { id: 'default', type: 'System', badge: 'LIVE', title: 'Welcome to Student ERP', subtitle: 'Checking latest campus updates...', time: 'Just now', link: '/dashboard' }
  ]);
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      ...
                      onMouseLeave={e => (e.currentTarget.style.transform = 'scale(1)')}
                      title={`Open ${currentNotif.type || 'Notice'}`}
                    >
