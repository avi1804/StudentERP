    ...
    <div className="fixed bottom-6 right-6 z-50 font-sans">
            ...
            >
              {!hasMessages ? (
                ...
                >
                  ...
                  >
                    I'm your StudentERP AI Assistant.<br />
                    I can help with:
                  </p>
                  <div 
                  ...
                  >
                    {[
                      ...
                      { icon: '📢', label: 'Notices' },
                      { icon: '✍️', label: 'Leave Applications' }
                    ].map((item, idx) => (
                      <div
                        key={idx}
                        className="flex items-center gap-3 p-3 bg-white rounded-2xl border border-slate-200/60"
                        style={{
                                  ...
                                  >
                                    ...
                                    <div 
                                      className={`flex items-center gap-1 mt-2 ${
                                        msg.isBot ? 'text-slate-400' : 'text-purple-200 justify-end'
                                      }`}
                                      style={{
                                        fontSize: '11px',
                                        fontWeight: 500
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <button 
                      className="flex items-center justify-center text-slate-500 hover:text-slate-700 hover:bg-slate-100 transition-all rounded-full"
      ...
      {!isOpen && (
        <motion.button
          ...
          className="flex items-center justify-center transition-all outline-none border-none"
          style={{
            width: '120px',
            height: '120px',
